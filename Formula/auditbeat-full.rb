class AuditbeatFull < Formula
  ...
  if OS.mac?
    ...
    url "https://artifacts.elastic.co/downloads/beats/auditbeat/auditbeat-7.17.8-linux-x86_64.tar.gz?tap=elastic/homebrew-tap"
    sha256 "cc80e57cd438ea6a4a4bd1b5943711471fba080359d832c1c58bd3b527454eaa"
  end
  version "7.17.8"
