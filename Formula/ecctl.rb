...
class Ecctl < Formula
  ...
  if OS.mac?
    url "https://download.elastic.co/downloads/ecctl/1.8.0/ecctl_1.8.0_darwin_amd64.tar.gz"
    sha256 "bd3b8facf6a472ef310be02483b07372c5cbfaca5090a2a0bc64d386e0817243"
  elsif OS.linux?
    url "https://download.elastic.co/downloads/ecctl/1.8.0/ecctl_1.8.0_linux_amd64.tar.gz"
